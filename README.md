...
# SN Elastic Cloud on Kubernetes

SN Elastic Cloud on Kubernetes is a fork of the official Elastic Cloud on Kubernetes (ECK) project, with adjustments made to better suit the SmartNews ecosystem.

Charts will be published following the naming convention below:
```
<official-chart-version>.number
```
